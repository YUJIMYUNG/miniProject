...
public class New_VoteDto {
    ...
    // 생성자
    public New_VoteDto(int vote_idx, String vote_content, int member_idx, LocalDateTime vote_deadline, boolean vote_status, int vote_num, String[] vote_choice, int vote_count) {
    ...
    // 투표 생성에 필요한 생성자
    public New_VoteDto(String vote_content, int vote_num, String[] vote_choice) {
        this.vote_content = vote_content;
        this.vote_num = vote_num;
        this.vote_choice = vote_choice;
    }
